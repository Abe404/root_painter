...
A 14 minute video showing how to install RootPainter on windows 11 with google drive and google colab is available on [youtube](https://www.youtube.com/watch?v=HuSujZQOkQw). A similar video is available showing how to [setup RootPainter with google drive and google colab on macOS](https://youtu.be/rBCkem0ub_I). I suggest watching these videos if you have trouble with the installation part of the colab tutorial.
